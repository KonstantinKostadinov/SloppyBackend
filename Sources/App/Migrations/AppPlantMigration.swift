...
struct AppPlantMigration: Migration {
    ...
    func prepare(on database: Database) -> EventLoopFuture<Void> {
        return database.schema("plants").field("id", .uuid).field("origin", .string, .required).field("names",.string,.required).field("maxGrowth", .string , .required).field("poisonousToPets",.string,.required).field("temperature",.string,.required).field("light",.string,.required).field("watering",.string,.required).field("soil",.string,.required).field("rePotting",.string,.required).field("airHumidity",.string,.required).field("propagation",.string,.required).field("whereItGrowsBest",.string,.required).field("potentialProblems",.array(of: .string),.required).create()
    }
